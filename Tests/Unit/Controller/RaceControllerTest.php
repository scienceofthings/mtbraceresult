...
/**
 * Test case for class Tx_Mtbraceresult_Controller_RaceController.
 *
 * @version $Id$
 ...
 */
class Tx_Mtbraceresult_Controller_RaceControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
