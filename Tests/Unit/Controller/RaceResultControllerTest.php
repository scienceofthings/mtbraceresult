...
/**
 * Test case for class Tx_Mtbraceresult_Controller_RaceResultController.
 *
 * @version $Id$
 ...
 */
class Tx_Mtbraceresult_Controller_RaceResultControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
