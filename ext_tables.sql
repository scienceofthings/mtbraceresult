#
# Table structure for table 'tx_mtbraceresult_domain_model_raceseries'
#
CREATE TABLE tx_mtbraceresult_domain_model_raceseries (
...
#
# Table structure for table 'tx_mtbraceresult_domain_model_race'
#
CREATE TABLE tx_mtbraceresult_domain_model_race (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_mtbraceresult_domain_model_raceresult (
	...
	racer int(11) unsigned DEFAULT '0',
